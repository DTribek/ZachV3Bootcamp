...
joined_df2 = joined_df.repartition(32, col('playlist_id')).sortWithinPartitions(col('playlist_id'), col('mapid'))
joined_df2.write.mode("overwrite").saveAsTable('diegotribek.sort_2')
