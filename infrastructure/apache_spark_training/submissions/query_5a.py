...
joined_df1 = joined_df.repartition(8, col('playlist_id')).sortWithinPartitions(col('playlist_id'), col('mapid'))
joined_df1.write.mode("overwrite").saveAsTable('diegotribek.sort_1')
